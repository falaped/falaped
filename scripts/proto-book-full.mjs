...
const TEXT = (layout, txt) => `The page contains EXACTLY the following Portuguese text, rendered character by character including accents, cedilla and punctuation. Every word appears exactly once, no word is skipped, repeated or split with a hyphen. Typeface: an elegant warm serif typeface (Cormorant Garamond / Playfair Display style), generous line spacing, large and fully legible, with small gold heart-and-line ornaments separating sentences. No other letters, words, signs or logos anywhere in the image. Layout: ${layout}. Text: "${txt}"`;
const L = {
...
const LEO = "Léo, a fair-skinned boy of the same age with short straight black hair, a green t-shirt and a green backpack";
const JESUS = "Jesus, a kind man with long brown hair and beard, cream robe and blue sash";

const PAGES = [
  { id: "00", refs: [], prompt: `${STYLE} ${CHARACTER} Scene: golden morning in front of a colorful, welcoming school with a wide open gate and a huge sunflower beside the entrance, the walls plain with no sign or plaque; the boy stands smiling with a backpack on, holding up the open palm of one hand toward the viewer, a small yellow sun drawn on the palm; soft light rays, birds. Cover layout: title in embossed golden 3D letters at the top, the child's name even larger inside a cream parchment plaque with ornate gold frame, and the subtitle written ONCE, in small dark-brown serif right below the plaque, nothing written at the bottom of the image. Render the texts EXACTLY, character by character, including accents. No other letters anywhere. Title: "O Sol na Mão de" Name: "${NOME}" Subtitle: "Uma história sobre fé, coragem e recomeços."` },
  { id: "01", refs: [], layout: "L1", scene: `quiet sunny street; a yellow house with a big mango tree in the front yard; the boy and ${JUJU} kick a ball under the tree, both laughing; a neighbor's dog watches from a fence.`, text: `${NOME} morava em uma casa amarela com uma mangueira no quintal. Ele conhecia cada canto daquela rua e cada vizinho. E tinha uma melhor amiga, a Juju, que morava na casa da frente.` },
  ...
  { id: "11", refs: [], layout: "L2", scene: `a huge colorful school gate with children of many ages running in, greeting each other; the boy stands still on the sidewalk, small before the gate, looking down at his own open palm where a small yellow sun is drawn on the skin with felt-tip pen (flat drawing on the palm, not a floating object).`, text: `O portão da escola era enorme e as crianças passavam correndo, todas se conhecendo. As pernas de ${NOME} travaram. Ele abriu a mão, olhou o sol e deu um passo. Depois outro.` },
  ...
  { id: "13", refs: [], layout: "L3", scene: `a lively school playground at recess, groups of children playing and eating together; the boy sits alone on a bench at the edge with a lunchbox on the lap, sad eyes, on the verge of tears.`, text: `No recreio, cada criança já tinha o seu grupo. ${NOME} sentou sozinho em um banco, com o lanche no colo, e sentiu o frio na barriga voltar. Ele quase chorou.` },
