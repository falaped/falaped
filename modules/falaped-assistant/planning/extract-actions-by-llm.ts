...
export { cleanupRawContent, parseActionsFromPayload } from "@/modules/falaped-assistant/planning/llm-action-parsers"
...
export async function extractActionsByLlm(userMessage: string): Promise<ExtractedActions> {
  ...
  try {
    ...
    console.error("[FALAPED_ASSISTANT] LLM action extraction failed", { error })
  }
