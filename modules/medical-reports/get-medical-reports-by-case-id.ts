...
/**
 * Medical reports linked to a case (case_id), for the profile. Newest first.
 */
export async function getMedicalReportsByCaseId(
  ...
  if (error) {
    throw new Error(`[MEDICAL_REPORTS] Failed to fetch by case: ${error.message}`)
  }
