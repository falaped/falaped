...
export const oDiaDaVacina: BookTheme = {
  ...
  pages: [
    ...
    {
      text: "A porta abriu e a Dra. Lia apareceu com seu jaleco branco e um sorriso enorme. Ela chamou {nome} pelo nome e disse que tinha uma missão importante para {ele|ela}.",
    ...
    {
      text: "No consultório, a Dra. Lia mostrou um desenho do corpo com os soldadinhos de escudo. Ela contou que a vacina entrega para eles a foto do vilão, para nunca mais serem enganados.",
    ...
    {
      text: "{nome} olhou para a bandeja com a seringa e engoliu em seco. As pernas quiseram correr. A Dra. Lia percebeu e disse que ter medo era normal, até para os corajosos.",
    ...
    {
      text: "A doutora deixou {nome} escolher: o braço direito ou o esquerdo, olhar ou não olhar, e o que contar durante a picada. {Ele|Ela} escolheu o esquerdo, não olhar, e contar até três.",
    ...
    {
      text: "A Dra. Lia abriu uma gaveta cheia de adesivos e deixou {nome} escolher. {Ele|Ela} pegou uma estrela dourada e colou bem no meio da camiseta, como uma medalha.",
    ...
    {
      text: "Antes de sair, a doutora explicou que o braço podia ficar dolorido ou um pouco quente. Isso era sinal de que os soldadinhos estavam trabalhando, e passaria logo.",
    ...
    {
      text: "Quando a Dra. Lia chamou, a menina levantou, respirou fundo e escolheu o braço direito. Da porta, ela olhou para {nome} e fez sinal de positivo.",
