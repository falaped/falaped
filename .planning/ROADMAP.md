...
**Plans**: 3 plans (v2 — v1 plans archived in `archive-v1/`)
- [ ] 06-01-PLAN.md — Migração híbrida ALTER+backfill + expandAvailability híbrida DST-safe + schema WR-02/03 (checkpoint de push da migração)
