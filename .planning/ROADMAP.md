...
- [x] 10-04-PLAN.md — Encerramento do caso: guarda de re-encerramento + validação de posse do caso (IDOR) + insert único de consulta+N procedimentos, hoist do popover e diálogo de duas etapas, aviso destrutivo em "Excluir caso" (checkpoint visual [BLOCKING], 7 itens)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 10-05-PLAN.md — Anulação com "Desfazer" (owner-scoped + specs) + resto do painel: navegação de período, filtro de anulados, gráfico diário, tabela e card de ganhos dentro do caso (checkpoint visual)
...
| 10. Livro-caixa de Ganhos & Painel | 5/5 | In Progress|  |
